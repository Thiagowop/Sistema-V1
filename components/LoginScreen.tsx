...
import { authenticateUser } from '../auth.config';
...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin }) => {
  ...
  const handleGoogleSuccess = (credentialResponse: any) => {
    ...
    // Decodificar JWT para pegar email
    // Por enquanto aceita qualquer login do Google com @mcsarc.com.br
    onLogin();
  };
    ...
    <div className="min-h-[100dvh] flex items-center justify-center bg-slate-900 relative overflow-hidden font-sans p-4">
      ...
      <div className="bg-white p-6 sm:p-10 md:p-12 rounded-2xl md:rounded-3xl shadow-2xl w-full max-w-[420px] relative z-10 border border-slate-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              ...
              <input
                ...
                placeholder="nome@mcsarc.com.br"
                required
              />
            </div>
          </div>
          ...
          {/* Google Login - only if configured */}
          {googleClientId && (
            <>
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-white px-2 text-slate-400 font-bold tracking-wide">Ou continue com</span>
                </div>
              </div>
