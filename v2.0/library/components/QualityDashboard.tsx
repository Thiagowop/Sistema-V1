...
export const QualityDashboard: React.FC<QualityDashboardProps> = ({ data }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 animate-fadeIn font-sans pb-12 relative">
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="pt-6 border-t border-slate-100 flex items-center justify-between gap-4">
                 ...
                 <button 
                   ...
                   className="flex items-center gap-2 px-8 py-3 bg-[#0f172a] text-white text-xs font-black rounded-xl hover:bg-slate-800 shadow-xl shadow-slate-200 transition-all active:scale-95"
                 >
